...
from db_manager import data_to_db_main
...
def get_images(driver, img_page_urls, host_urls, mag_names, owners, s_type):
    ...
    for img_page_url in img_page_urls:
        ...
        if image_page.status_code == 200:
            ...
            data_to_db_main(matches_img_url, mag_names, owners, metadata, credit, host_urls, img_page_url, s_type, art_date, art_title, db_creds)
